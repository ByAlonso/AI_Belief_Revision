...
from belief_base_2 import BeliefBase

if __name__ == '__main__':
    #belief_base = BeliefBase()
    belief_base = BeliefBase()
    #belief_base_2 = BeliefBase2([Belief("(C173|C220)>>ACS"),Belief('C173'),Belief('C240')])#Just some testing I was doing yesterday
    while True:
        ...
        if action == "quit" or action == "4":
            ...
            print(belief_base_2.resolution(belief_base_2.belief_base,Belief("~ACS")))
        else:
